// SPDX-FileCopyrightText: 2009-2010, 2013-2016, 2026 BitLoupe developers
...
public:
    ...
    static constexpr const char* SchemaId = "https://bitloupe.org/schemas/theme-v1.schema.json";
