// SPDX-FileCopyrightText: 2015-2017, 2020, 2026 SpeedCrunch developers
...
void test_functions()
{
    ...
    CHECK_FORMAT(Format::Hexadecimal() + Format::Fixed(), CMath::encodeIeee754("0.999755859375", "5", "10"), "0x3C00");
