...
QString applySuperscriptStyleToUnitName(QString unitName)
{
    ...
    using PrefixSpec = UnitPrefixSpec;
} // namespace
...
const QHash<UnitId, UnitSpec>& s_unitSpecs()
{
    ...
    static const QHash<UnitId, UnitSpec> specs = {
        // SI base units
        {UnitId::Second, UnitSpec{UnitName::Second, QT_TRANSLATE_NOOP("Editor", "second"), UnitSymbol::Second, {}, UnitFamily::SiBase, {UnitQuantity::Time}, EngineeringSiPrefixes, &Units::second}},
        {UnitId::Metre, UnitSpec{UnitName::Metre, QT_TRANSLATE_NOOP("Editor", "metre"), UnitSymbol::Metre, {}, UnitFamily::SiBase, {UnitQuantity::Length}, EngineeringSiPrefixes | SmallSiPrefixes, &Units::metre}},
        {UnitId::Kilogram, UnitSpec{UnitName::Kilogram, QT_TRANSLATE_NOOP("Editor", "kilogram"), UnitSymbol::Kilogram, {}, UnitFamily::SiBase, {UnitQuantity::Mass}, NoPrefixes, &Units::kilogram}},
        {UnitId::Ampere, UnitSpec{UnitName::Ampere, "Ampere", UnitSymbol::Ampere, {}, UnitFamily::SiBase, {UnitQuantity::ElectricCurrent}, EngineeringSiPrefixes, &Units::ampere}},
        {UnitId::Kelvin, UnitSpec{UnitName::Kelvin, "Kelvin", UnitSymbol::Kelvin, {}, UnitFamily::SiBase, {UnitQuantity::ThermodynamicTemperature}, EngineeringSiPrefixes, &Units::kelvin}},
        {UnitId::Mole, UnitSpec{UnitName::Mole, QT_TRANSLATE_NOOP("Editor", "mole"), UnitSymbol::Mole, {}, UnitFamily::SiBase, {UnitQuantity::AmountOfSubstance}, EngineeringSiPrefixes, &Units::mole}},
        {UnitId::Candela, UnitSpec{UnitName::Candela, "candela", UnitSymbol::Candela, {}, UnitFamily::SiBase, {UnitQuantity::LuminousIntensity}, EngineeringSiPrefixes, &Units::candela}},
        // SI derived units
        {UnitId::Radian, UnitSpec{UnitName::Radian, QT_TRANSLATE_NOOP("Editor", "radian"), UnitSymbol::Radian, {}, UnitFamily::SiDerived, {UnitQuantity::PlaneAngle}, EngineeringSiPrefixes, &Units::radian}},
        {UnitId::Steradian, UnitSpec{UnitName::Steradian, QT_TRANSLATE_NOOP("Editor", "steradian"), UnitSymbol::Steradian, {}, UnitFamily::SiDerived, {UnitQuantity::SolidAngle}, EngineeringSiPrefixes, &Units::steradian}},
        {UnitId::Hertz, UnitSpec{UnitName::Hertz, "Hertz", UnitSymbol::Hertz, {}, UnitFamily::SiDerived, {UnitQuantity::Frequency}, EngineeringSiPrefixes, &Units::hertz}},
        {UnitId::Newton, UnitSpec{UnitName::Newton, "Newton", UnitSymbol::Newton, {}, UnitFamily::SiDerived, {UnitQuantity::Force}, EngineeringSiPrefixes | SmallPositiveSiPrefixes, &Units::newton}},
        {UnitId::Pascal, UnitSpec{UnitName::Pascal, "Pascal", UnitSymbol::Pascal, {}, UnitFamily::SiDerived, {UnitQuantity::Pressure, UnitQuantity::Stress}, EngineeringSiPrefixes | SmallPositiveSiPrefixes, &Units::pascal}},
        {UnitId::Joule, UnitSpec{UnitName::Joule, "Joule", UnitSymbol::Joule, {}, UnitFamily::SiDerived, {UnitQuantity::Energy, UnitQuantity::Work, UnitQuantity::AmountOfHeat}, EngineeringSiPrefixes, &Units::joule}},
        {UnitId::Watt, UnitSpec{UnitName::Watt, "Watt", UnitSymbol::Watt, {}, UnitFamily::SiDerived, {UnitQuantity::Power, UnitQuantity::RadiantFlux}, EngineeringSiPrefixes, &Units::watt}},
        {UnitId::Coulomb, UnitSpec{UnitName::Coulomb, "Coulomb", UnitSymbol::Coulomb, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricCharge}, EngineeringSiPrefixes, &Units::coulomb}},
        {UnitId::Volt, UnitSpec{UnitName::Volt, "Volt", UnitSymbol::Volt, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricPotentialDifference}, EngineeringSiPrefixes, &Units::volt}},
        {UnitId::Farad, UnitSpec{UnitName::Farad, "Farad", UnitSymbol::Farad, {}, UnitFamily::SiDerived, {UnitQuantity::Capacitance}, EngineeringSiPrefixes, &Units::farad}},
        {UnitId::Ohm, UnitSpec{UnitName::Ohm, "Ohm", UnitSymbol::Ohm, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricResistance}, EngineeringSiPrefixes, &Units::ohm}},
        {UnitId::Siemens, UnitSpec{UnitName::Siemens, "Siemens", UnitSymbol::Siemens, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricConductance}, EngineeringSiPrefixes, &Units::siemens}},
        {UnitId::Weber, UnitSpec{UnitName::Weber, "Weber", UnitSymbol::Weber, {}, UnitFamily::SiDerived, {UnitQuantity::MagneticFlux}, EngineeringSiPrefixes, &Units::weber}},
        {UnitId::Tesla, UnitSpec{UnitName::Tesla, "Tesla", UnitSymbol::Tesla, {}, UnitFamily::SiDerived, {UnitQuantity::MagneticFluxDensity}, EngineeringSiPrefixes, &Units::tesla}},
        {UnitId::Henry, UnitSpec{UnitName::Henry, "Henry", UnitSymbol::Henry, {}, UnitFamily::SiDerived, {UnitQuantity::Inductance}, EngineeringSiPrefixes, &Units::henry}},
        {UnitId::DegreeCelsius, UnitSpec{UnitName::DegreeCelsius, QT_TRANSLATE_NOOP("Editor", "degree Celsius"), UnitSymbol::DegreeCelsius, {UnitAltSymbol::DegreeCelsius1, UnitAltSymbol::DegreeCelsius2, UnitAltSymbol::DegreeCelsius3, UnitAltSymbol::DegreeCelsius4, UnitAltSymbol::DegreeCelsius5}, UnitFamily::SiAccepted, {UnitQuantity::CelsiusTemperature}, NoPrefixes, &Units::kelvin, {&s_celsiusToKelvin, &s_kelvinToCelsius}}},
        {UnitId::Lumen, UnitSpec{UnitName::Lumen, "lumen", UnitSymbol::Lumen, {}, UnitFamily::SiDerived, {UnitQuantity::LuminousFlux}, EngineeringSiPrefixes, &Units::lumen}},
        {UnitId::Lux, UnitSpec{UnitName::Lux, "lux", UnitSymbol::Lux, {}, UnitFamily::SiDerived, {UnitQuantity::Illuminance}, EngineeringSiPrefixes, &Units::lux}},
        {UnitId::Becquerel, UnitSpec{UnitName::Becquerel, "Becquerel", UnitSymbol::Becquerel, {}, UnitFamily::SiDerived, {UnitQuantity::ActivityReferredToARadionuclide}, EngineeringSiPrefixes, &Units::becquerel}},
        {UnitId::Gray, UnitSpec{UnitName::Gray, "Gray", UnitSymbol::Gray, {}, UnitFamily::SiDerived, {UnitQuantity::AbsorbedDose, UnitQuantity::Kerma}, EngineeringSiPrefixes, &Units::gray}},
        {UnitId::Sievert, UnitSpec{UnitName::Sievert, "sievert", UnitSymbol::Sievert, {}, UnitFamily::SiDerived, {UnitQuantity::DoseEquivalent}, EngineeringSiPrefixes, &Units::sievert}},
        {UnitId::Katal, UnitSpec{UnitName::Katal, "katal", UnitSymbol::Katal, {}, UnitFamily::SiDerived, {UnitQuantity::CatalyticActivity}, EngineeringSiPrefixes, &Units::katal}},
        {UnitId::CubicMetre, UnitSpec{UnitName::CubicMetre, QT_TRANSLATE_NOOP("Editor", "cubic metre"), UnitSymbol::CubicMetre, {}, UnitFamily::SiDerived, {UnitQuantity::Volume}, EngineeringSiPrefixes | SmallNegativeSiPrefixes, &Units::cubic_metre}},
        {UnitId::CubicMillimetre, UnitSpec{UnitName::CubicMillimetre, QT_TRANSLATE_NOOP("Editor", "cubic millimetre"), UnitSymbol::CubicMillimetre, {}, UnitFamily::SiDerived, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_millimetre}},
        {UnitId::CubicCentimetre, UnitSpec{UnitName::CubicCentimetre, QT_TRANSLATE_NOOP("Editor", "cubic centimetre"), UnitSymbol::CubicCentimetre, {UnitAltSymbol::CubicCentimetre}, UnitFamily::SiDerived, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_centimetre}},
        {UnitId::CubicDecimetre, UnitSpec{UnitName::CubicDecimetre, QT_TRANSLATE_NOOP("Editor", "cubic decimetre"), UnitSymbol::CubicDecimetre, {}, UnitFamily::SiDerived, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_decimetre}},
        {UnitId::CubicKilometre, UnitSpec{UnitName::CubicKilometre, QT_TRANSLATE_NOOP("Editor", "cubic kilometre"), UnitSymbol::CubicKilometre, {}, UnitFamily::SiDerived, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_kilometre}},
        {UnitId::SquareMillimetre, UnitSpec{UnitName::SquareMillimetre, QT_TRANSLATE_NOOP("Editor", "square millimetre"), UnitSymbol::SquareMillimetre, {}, UnitFamily::SiDerived, {UnitQuantity::Area}, NoPrefixes, &Units::square_millimetre}},
        {UnitId::SquareKilometre, UnitSpec{UnitName::SquareKilometre, QT_TRANSLATE_NOOP("Editor", "square kilometre"), UnitSymbol::SquareKilometre, {}, UnitFamily::SiDerived, {UnitQuantity::Area}, NoPrefixes, &Units::square_kilometre}},
        {UnitId::SquareMetre, UnitSpec{UnitName::SquareMetre, QT_TRANSLATE_NOOP("Editor", "square metre"), UnitSymbol::SquareMetre, {}, UnitFamily::SiDerived, {UnitQuantity::Area}, EngineeringSiPrefixes | SmallNegativeSiPrefixes, &Units::square_metre}},
        // SI-accepted units
        {UnitId::Minute, UnitSpec{UnitName::Minute, QT_TRANSLATE_NOOP("Editor", "minute"), UnitSymbol::Minute, {}, UnitFamily::SiAccepted, {UnitQuantity::Time}, NoPrefixes, &Units::minute}},
        {UnitId::Hour, UnitSpec{UnitName::Hour, QT_TRANSLATE_NOOP("Editor", "hour"), UnitSymbol::Hour, {}, UnitFamily::SiAccepted, {UnitQuantity::Time}, NoPrefixes, &Units::hour}},
        {UnitId::Day, UnitSpec{UnitName::Day, QT_TRANSLATE_NOOP("Editor", "day"), UnitSymbol::Day, {}, UnitFamily::SiAccepted, {UnitQuantity::Time}, NoPrefixes, &Units::day}},
        {UnitId::AstronomicalUnit, UnitSpec{UnitName::AstronomicalUnit, QT_TRANSLATE_NOOP("Editor", "astronomical unit"), UnitSymbol::AstronomicalUnit, {}, UnitFamily::SiAccepted, {UnitQuantity::Length}, NoPrefixes, &Units::astronomical_unit}},
        {UnitId::Degree, UnitSpec{UnitName::Degree, QT_TRANSLATE_NOOP("Editor", "degree"), UnitSymbol::Degree, {UnitAltSymbol::Degree1, UnitAltSymbol::Degree2}, UnitFamily::SiAccepted, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::degree}},
        {UnitId::Arcminute, UnitSpec{UnitName::Arcminute, QT_TRANSLATE_NOOP("Editor", "arcminute"), UnitSymbol::Arcminute, {UnitAltSymbol::Arcminute}, UnitFamily::SiAccepted, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::arcminute}},
        {UnitId::Arcsecond, UnitSpec{UnitName::Arcsecond, QT_TRANSLATE_NOOP("Editor", "arcsecond"), UnitSymbol::Arcsecond, {UnitAltSymbol::Arcsecond}, UnitFamily::SiAccepted, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::arcsecond}},
        {UnitId::Milliarcsecond, UnitSpec{UnitName::Milliarcsecond, QT_TRANSLATE_NOOP("Editor", "milliarcsecond"), UnitSymbol::Milliarcsecond, {}, UnitFamily::SiAccepted, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::milliarcsecond}},
        {UnitId::Microarcsecond, UnitSpec{UnitName::Microarcsecond, QT_TRANSLATE_NOOP("Editor", "microarcsecond"), UnitSymbol::Microarcsecond, {UnitAltSymbol::MicroarcsecondAscii}, UnitFamily::SiAccepted, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::microarcsecond}},
        {UnitId::Hectare, UnitSpec{UnitName::Hectare, QT_TRANSLATE_NOOP("Editor", "hectare"), UnitSymbol::Hectare, {}, UnitFamily::SiAccepted, {UnitQuantity::Area}, NoPrefixes, &Units::hectare}},
        {UnitId::Litre, UnitSpec{UnitName::Litre, QT_TRANSLATE_NOOP("Editor", "litre"), UnitSymbol::Litre, {UnitAltSymbol::Litre}, UnitFamily::SiAccepted, {UnitQuantity::Volume}, EngineeringSiPrefixes | SmallSiPrefixes, &Units::litre}},
        {UnitId::Tonne, UnitSpec{UnitName::Tonne, QT_TRANSLATE_NOOP("Editor", "tonne"), UnitSymbol::Tonne, {}, UnitFamily::SiAccepted, {UnitQuantity::Mass}, NoPrefixes, &Units::tonne}},
        {UnitId::Dalton, UnitSpec{UnitName::Dalton, QT_TRANSLATE_NOOP("Editor", "Dalton"), UnitSymbol::Dalton, {}, UnitFamily::SiAccepted, {UnitQuantity::Mass}, NoPrefixes, &Units::atomic_mass_unit}},
        {UnitId::Electronvolt, UnitSpec{UnitName::Electronvolt, QT_TRANSLATE_NOOP("Editor", "electronvolt"), UnitSymbol::Electronvolt, {}, UnitFamily::SiAccepted, {UnitQuantity::Energy}, EngineeringSiPrefixes, &Units::electronvolt}},

        {UnitId::Acre, UnitSpec{UnitName::Acre, "acre", UnitSymbol::Acre, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::acre}},
        {UnitId::Angstrom, UnitSpec{UnitName::Angstrom, QT_TRANSLATE_NOOP("Editor", "Angstrom"), UnitSymbol::Angstrom, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::angstrom}},
        {UnitId::Atmosphere, UnitSpec{UnitName::Atmosphere, QT_TRANSLATE_NOOP("Editor", "atmosphere"), UnitSymbol::Atmosphere, {}, UnitFamily::Other, {UnitQuantity::Pressure}, NoPrefixes, &Units::atmosphere}},
        {UnitId::AtomicMassUnit, UnitSpec{UnitName::AtomicMassUnit, QT_TRANSLATE_NOOP("Editor", "atomic mass unit"), UnitSymbol::AtomicMassUnit, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::atomic_mass_unit}},
        {UnitId::Bar, UnitSpec{UnitName::Bar, "bar", UnitSymbol::Bar, {}, UnitFamily::Other, {UnitQuantity::Pressure}, EngineeringSiPrefixes, &Units::bar}},
        {UnitId::Bit, UnitSpec{UnitName::Bit, "bit", UnitSymbol::Bit, {}, UnitFamily::Other, {UnitQuantity::Information}, PositiveEngineeringSiPrefixes | BinaryIecPrefixes, &Units::bit}},
        {UnitId::BritishThermalUnit, UnitSpec{UnitName::BritishThermalUnit, QT_TRANSLATE_NOOP("Editor", "British thermal unit"), UnitSymbol::BritishThermalUnit, {}, UnitFamily::Other, {UnitQuantity::AmountOfHeat}, NoPrefixes, &Units::british_thermal_unit}},
        {UnitId::Byte, UnitSpec{UnitName::Byte, "byte", UnitSymbol::Byte, {}, UnitFamily::Other, {UnitQuantity::Information}, PositiveEngineeringSiPrefixes | BinaryIecPrefixes, &Units::byte}},
        {UnitId::Calorie, UnitSpec{UnitName::Calorie, QT_TRANSLATE_NOOP("Editor", "calorie"), UnitSymbol::Calorie, {}, UnitFamily::Other, {UnitQuantity::AmountOfHeat}, NoPrefixes, &Units::calorie}},
        {UnitId::Carat, UnitSpec{UnitName::Carat, QT_TRANSLATE_NOOP("Editor", "carat"), UnitSymbol::Carat, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::carat}},
        {UnitId::Cup, UnitSpec{UnitName::Cup, QT_TRANSLATE_NOOP("Editor", "cup"), UnitSymbol::Cup, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cup}},
        {UnitId::CupImp, UnitSpec{UnitName::CupImp, QT_TRANSLATE_NOOP("Editor", "cup (Imperial)"), UnitSymbol::CupImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cup_imp}},
        {UnitId::CupJp, UnitSpec{UnitName::CupJp, QT_TRANSLATE_NOOP("Editor", "cup (Japanese)"), UnitSymbol::CupJp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cup_jp}},
        {UnitId::CupUs, UnitSpec{UnitName::CupUs, QT_TRANSLATE_NOOP("Editor", "cup (US)"), UnitSymbol::CupUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cup_us}},
        {UnitId::DegreeFahrenheit, UnitSpec{UnitName::DegreeFahrenheit, QT_TRANSLATE_NOOP("Editor", "degree Fahrenheit"), UnitSymbol::DegreeFahrenheit, {UnitAltSymbol::DegreeFahrenheit1, UnitAltSymbol::DegreeFahrenheit2, UnitAltSymbol::DegreeFahrenheit3, UnitAltSymbol::DegreeFahrenheit4, UnitAltSymbol::DegreeFahrenheit5}, UnitFamily::Other, {UnitQuantity::CelsiusTemperature}, NoPrefixes, &Units::kelvin, {&s_fahrenheitToKelvin, &s_kelvinToFahrenheit}}},
        {UnitId::Fathom, UnitSpec{UnitName::Fathom, QT_TRANSLATE_NOOP("Editor", "fathom"), UnitSymbol::Fathom, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::fathom}},
        {UnitId::FluidOunceImp, UnitSpec{UnitName::FluidOunceImp, QT_TRANSLATE_NOOP("Editor", "fluid ounce (Imperial)"), UnitSymbol::FluidOunceImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::fluid_ounce_imp}},
        {UnitId::FluidOunceUs, UnitSpec{UnitName::FluidOunceUs, QT_TRANSLATE_NOOP("Editor", "fluid ounce (US)"), UnitSymbol::FluidOunceUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::fluid_ounce_us}},
        {UnitId::FluidDramImp, UnitSpec{UnitName::FluidDramImp, QT_TRANSLATE_NOOP("Editor", "fluid dram (Imperial)"), UnitSymbol::FluidDramImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::fluid_dram_imp}},
        {UnitId::FluidDramUs, UnitSpec{UnitName::FluidDramUs, QT_TRANSLATE_NOOP("Editor", "fluid dram (US)"), UnitSymbol::FluidDramUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::fluid_dram_us}},
        {UnitId::Foot, UnitSpec{UnitName::Foot, QT_TRANSLATE_NOOP("Editor", "foot"), UnitSymbol::Foot, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::foot}},
        {UnitId::SquareFoot, UnitSpec{UnitName::SquareFoot, QT_TRANSLATE_NOOP("Editor", "square foot"), UnitSymbol::SquareFoot, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::square_foot}},
        {UnitId::CubicFoot, UnitSpec{UnitName::CubicFoot, QT_TRANSLATE_NOOP("Editor", "cubic foot"), UnitSymbol::CubicFoot, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_foot}},
        {UnitId::Furlong, UnitSpec{UnitName::Furlong, "furlong", UnitSymbol::Furlong, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::furlong}},
        {UnitId::GallonImp, UnitSpec{UnitName::GallonImp, QT_TRANSLATE_NOOP("Editor", "gallon (Imperial)"), UnitSymbol::GallonImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::gallon_imp}},
        {UnitId::GallonUs, UnitSpec{UnitName::GallonUs, QT_TRANSLATE_NOOP("Editor", "gallon (US)"), UnitSymbol::GallonUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::gallon_us}},
        {UnitId::GillImp, UnitSpec{UnitName::GillImp, QT_TRANSLATE_NOOP("Editor", "gill (Imperial)"), UnitSymbol::GillImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::gill_imp}},
        {UnitId::GillUs, UnitSpec{UnitName::GillUs, QT_TRANSLATE_NOOP("Editor", "gill (US)"), UnitSymbol::GillUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::gill_us}},
        {UnitId::Gradian, UnitSpec{UnitName::Gradian, QT_TRANSLATE_NOOP("Editor", "gradian"), UnitSymbol::Gradian, {}, UnitFamily::Other, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::gradian}},
        {UnitId::Grain, UnitSpec{UnitName::Grain, QT_TRANSLATE_NOOP("Editor", "grain"), UnitSymbol::Grain, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::grain}},
        {UnitId::Gram, UnitSpec{UnitName::Gram, QT_TRANSLATE_NOOP("Editor", "gram"), UnitSymbol::Gram, {}, UnitFamily::Other, {UnitQuantity::Mass}, EngineeringSiPrefixes | SmallSiPrefixes, &Units::gram}},
        {UnitId::Hartley, UnitSpec{UnitName::Hartley, QT_TRANSLATE_NOOP("Editor", "Hartley"), UnitSymbol::Hartley, {}, UnitFamily::Other, {UnitQuantity::Information}, NoPrefixes, &Units::hartley}},
        {UnitId::HartreeEnergyUnit, UnitSpec{UnitName::HartreeEnergyUnit, QT_TRANSLATE_NOOP("Editor", "Hartree energy unit"), UnitSymbol::HartreeEnergyUnit, {}, UnitFamily::Other, {UnitQuantity::Energy}, NoPrefixes, &s_hartreeEnergyUnit}},
        {UnitId::Horsepower, UnitSpec{UnitName::Horsepower, QT_TRANSLATE_NOOP("Editor", "horsepower"), UnitSymbol::Horsepower, {}, UnitFamily::Other, {UnitQuantity::Power}, NoPrefixes, &Units::horsepower}},
        {UnitId::Inch, UnitSpec{UnitName::Inch, QT_TRANSLATE_NOOP("Editor", "inch"), UnitSymbol::Inch, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::inch}},
        {UnitId::SquareInch, UnitSpec{UnitName::SquareInch, QT_TRANSLATE_NOOP("Editor", "square inch"), UnitSymbol::SquareInch, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::square_inch}},
        {UnitId::CubicInch, UnitSpec{UnitName::CubicInch, QT_TRANSLATE_NOOP("Editor", "cubic inch"), UnitSymbol::CubicInch, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_inch}},
        {UnitId::Karat, UnitSpec{UnitName::Karat, QT_TRANSLATE_NOOP("Editor", "karat"), UnitSymbol::Karat, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::karat}},
        {UnitId::Knot, UnitSpec{UnitName::Knot, QT_TRANSLATE_NOOP("Editor", "knot"), UnitSymbol::Knot, {}, UnitFamily::Other, {UnitQuantity::Speed, UnitQuantity::Velocity}, NoPrefixes, &Units::knot}},
        {UnitId::Lightminute, UnitSpec{UnitName::Lightminute, QT_TRANSLATE_NOOP("Editor", "lightminute"), UnitSymbol::Lightminute, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::lightminute}},
        {UnitId::Lightsecond, UnitSpec{UnitName::Lightsecond, QT_TRANSLATE_NOOP("Editor", "lightsecond"), UnitSymbol::Lightsecond, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::lightsecond}},
        {UnitId::Lightyear, UnitSpec{UnitName::Lightyear, QT_TRANSLATE_NOOP("Editor", "lightyear"), UnitSymbol::Lightyear, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::lightyear}},
        {UnitId::LongTon, UnitSpec{UnitName::LongTon, QT_TRANSLATE_NOOP("Editor", "long ton"), UnitSymbol::LongTon, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::long_ton}},
        {UnitId::Mile, UnitSpec{UnitName::Mile, QT_TRANSLATE_NOOP("Editor", "mile"), UnitSymbol::Mile, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::mile}},
        {UnitId::SquareMile, UnitSpec{UnitName::SquareMile, QT_TRANSLATE_NOOP("Editor", "square mile"), UnitSymbol::SquareMile, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::square_mile}},
        {UnitId::CubicMile, UnitSpec{UnitName::CubicMile, QT_TRANSLATE_NOOP("Editor", "cubic mile"), UnitSymbol::CubicMile, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_mile}},
        {UnitId::MilePerHour, UnitSpec{UnitName::MilePerHour, QT_TRANSLATE_NOOP("Editor", "mile per hour"), UnitSymbol::MilePerHour, {}, UnitFamily::Other, {UnitQuantity::Speed, UnitQuantity::Velocity}, NoPrefixes, &Units::mile_per_hour}},
        {UnitId::KilometrePerHour, UnitSpec{UnitName::KilometrePerHour, QT_TRANSLATE_NOOP("Editor", "kilometre per hour"), UnitSymbol::KilometrePerHour, {}, UnitFamily::Other, {UnitQuantity::Speed, UnitQuantity::Velocity}, NoPrefixes, &Units::kilometre_per_hour}},
        {UnitId::Nat, UnitSpec{UnitName::Nat, "nat", UnitSymbol::Nat, {}, UnitFamily::Other, {UnitQuantity::Information}, NoPrefixes, &Units::nat}},
        {UnitId::NauticalMile, UnitSpec{UnitName::NauticalMile, QT_TRANSLATE_NOOP("Editor", "nautical mile"), UnitSymbol::NauticalMile, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::nautical_mile}},
        {UnitId::Ounce, UnitSpec{UnitName::Ounce, QT_TRANSLATE_NOOP("Editor", "ounce"), UnitSymbol::Ounce, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::ounce}},
        {UnitId::Parsec, UnitSpec{UnitName::Parsec, QT_TRANSLATE_NOOP("Editor", "parsec"), UnitSymbol::Parsec, {}, UnitFamily::Other, {UnitQuantity::Length}, PositiveEngineeringSiPrefixes, &Units::parsec}},
        {UnitId::PintImp, UnitSpec{UnitName::PintImp, QT_TRANSLATE_NOOP("Editor", "pint (Imperial)"), UnitSymbol::PintImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::pint_imp}},
        {UnitId::PintUs, UnitSpec{UnitName::PintUs, QT_TRANSLATE_NOOP("Editor", "pint (US)"), UnitSymbol::PintUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::pint_us}},
        {UnitId::Pound, UnitSpec{UnitName::Pound, QT_TRANSLATE_NOOP("Editor", "pound"), UnitSymbol::Pound, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::pound}},
        {UnitId::PoundsPerSqinch, UnitSpec{UnitName::PoundsPerSqinch, QT_TRANSLATE_NOOP("Editor", "pounds per square inch"), UnitSymbol::PoundsPerSqinch, {}, UnitFamily::Other, {UnitQuantity::Pressure}, NoPrefixes, &Units::pounds_per_sqinch}},
        {UnitId::QuartImp, UnitSpec{UnitName::QuartImp, QT_TRANSLATE_NOOP("Editor", "quart (Imperial)"), UnitSymbol::QuartImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::quart_imp}},
        {UnitId::QuartUs, UnitSpec{UnitName::QuartUs, QT_TRANSLATE_NOOP("Editor", "quart (US)"), UnitSymbol::QuartUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::quart_us}},
        {UnitId::BarrelOil, UnitSpec{UnitName::BarrelOil, QT_TRANSLATE_NOOP("Editor", "oil barrel"), UnitSymbol::BarrelOil, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::barrel_oil}},
        {UnitId::BarrelBeerUs, UnitSpec{UnitName::BarrelBeerUs, QT_TRANSLATE_NOOP("Editor", "beer barrel (US)"), UnitSymbol::BarrelBeerUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::barrel_beer_us}},
        {UnitId::Rod, UnitSpec{UnitName::Rod, "rod", UnitSymbol::Rod, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::rod}},
        {UnitId::SquareYard, UnitSpec{UnitName::SquareYard, QT_TRANSLATE_NOOP("Editor", "square yard"), UnitSymbol::SquareYard, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::square_yard}},
        {UnitId::CubicYard, UnitSpec{UnitName::CubicYard, QT_TRANSLATE_NOOP("Editor", "cubic yard"), UnitSymbol::CubicYard, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::cubic_yard}},
        {UnitId::ShortTon, UnitSpec{UnitName::ShortTon, QT_TRANSLATE_NOOP("Editor", "short ton"), UnitSymbol::ShortTon, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::short_ton}},
        {UnitId::Stone, UnitSpec{UnitName::Stone, "stone", UnitSymbol::Stone, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::stone}},
        {UnitId::Tablespoon, UnitSpec{UnitName::Tablespoon, QT_TRANSLATE_NOOP("Editor", "tablespoon"), UnitSymbol::Tablespoon, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::tablespoon}},
        {UnitId::TablespoonAu, UnitSpec{UnitName::TablespoonAu, QT_TRANSLATE_NOOP("Editor", "tablespoon (Australian)"), UnitSymbol::TablespoonAu, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::tablespoon_au}},
        {UnitId::TablespoonImp, UnitSpec{UnitName::TablespoonImp, QT_TRANSLATE_NOOP("Editor", "tablespoon (Imperial)"), UnitSymbol::TablespoonImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::tablespoon_imp}},
        {UnitId::TablespoonUs, UnitSpec{UnitName::TablespoonUs, QT_TRANSLATE_NOOP("Editor", "tablespoon (US)"), UnitSymbol::TablespoonUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::tablespoon_us}},
        {UnitId::DessertSpoon, UnitSpec{UnitName::DessertSpoon, QT_TRANSLATE_NOOP("Editor", "dessert spoon"), UnitSymbol::DessertSpoon, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::dessert_spoon}},
        {UnitId::Teaspoon, UnitSpec{UnitName::Teaspoon, QT_TRANSLATE_NOOP("Editor", "teaspoon"), UnitSymbol::Teaspoon, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::teaspoon}},
        {UnitId::TeaspoonImp, UnitSpec{UnitName::TeaspoonImp, QT_TRANSLATE_NOOP("Editor", "teaspoon (Imperial)"), UnitSymbol::TeaspoonImp, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::teaspoon_imp}},
        {UnitId::TeaspoonUs, UnitSpec{UnitName::TeaspoonUs, QT_TRANSLATE_NOOP("Editor", "teaspoon (US)"), UnitSymbol::TeaspoonUs, {}, UnitFamily::Other, {UnitQuantity::Volume}, NoPrefixes, &Units::teaspoon_us}},
        {UnitId::Torr, UnitSpec{UnitName::Torr, "Torr", UnitSymbol::Torr, {}, UnitFamily::Other, {UnitQuantity::Pressure}, NoPrefixes, &Units::torr}},
        {UnitId::Turn, UnitSpec{UnitName::Turn, QT_TRANSLATE_NOOP("Editor", "turn"), UnitSymbol::Turn, {UnitAltSymbol::Turn}, UnitFamily::Other, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::turn}},
        {UnitId::Revolution, UnitSpec{UnitName::Revolution, QT_TRANSLATE_NOOP("Editor", "revolution"), UnitSymbol::Revolution, {}, UnitFamily::Other, {UnitQuantity::PlaneAngle}, NoPrefixes, &Units::revolution}},
        {UnitId::RevolutionPerMinute, UnitSpec{UnitName::RevolutionPerMinute, QT_TRANSLATE_NOOP("Editor", "revolution per minute"), UnitSymbol::RevolutionPerMinute, {}, UnitFamily::Other, {UnitQuantity::Frequency}, NoPrefixes, &Units::revolution_per_minute}},
        {UnitId::Week, UnitSpec{UnitName::Week, QT_TRANSLATE_NOOP("Editor", "week"), UnitSymbol::Week, {}, UnitFamily::Other, {UnitQuantity::Time}, NoPrefixes, &Units::week}},
        {UnitId::KilowattHour, UnitSpec{UnitName::KilowattHour, QT_TRANSLATE_NOOP("Editor", "kilowatt hour"), UnitSymbol::KilowattHour, {}, UnitFamily::Other, {UnitQuantity::Energy, UnitQuantity::Work, UnitQuantity::AmountOfHeat}, NoPrefixes, &Units::kilowatt_hour}},
        {UnitId::MillimetreOfMercury, UnitSpec{UnitName::MillimetreOfMercury, QT_TRANSLATE_NOOP("Editor", "millimetre of mercury"), UnitSymbol::MillimetreOfMercury, {}, UnitFamily::Other, {UnitQuantity::Pressure}, NoPrefixes, &Units::millimetre_of_mercury}},
        {UnitId::Quad, UnitSpec{UnitName::Quad, "quad", UnitSymbol::Quad, {}, UnitFamily::Other, {UnitQuantity::AmountOfHeat}, NoPrefixes, &Units::quad}},
        {UnitId::Yard, UnitSpec{UnitName::Yard, QT_TRANSLATE_NOOP("Editor", "yard"), UnitSymbol::Yard, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::yard}},
        {UnitId::CenturyJulian, UnitSpec{UnitName::CenturyJulian, QT_TRANSLATE_NOOP("Editor", "Julian century"), UnitSymbol::CenturyJulian, {}, UnitFamily::Other, {UnitQuantity::Time}, NoPrefixes, &Units::julian_century}},
        {UnitId::YearJulian, UnitSpec{UnitName::YearJulian, QT_TRANSLATE_NOOP("Editor", "Julian year"), UnitSymbol::YearJulian, {}, UnitFamily::Other, {UnitQuantity::Time}, NoPrefixes, &Units::julian_year}},
        {UnitId::YearSidereal, UnitSpec{UnitName::YearSidereal, QT_TRANSLATE_NOOP("Editor", "sidereal year"), UnitSymbol::YearSidereal, {}, UnitFamily::Other, {UnitQuantity::Time}, NoPrefixes, &Units::sidereal_year}},
        {UnitId::YearTropical, UnitSpec{UnitName::YearTropical, QT_TRANSLATE_NOOP("Editor", "tropical year"), UnitSymbol::YearTropical, {}, UnitFamily::Other, {UnitQuantity::Time}, NoPrefixes, &Units::tropical_year}},
    };
    return specs;
}
...
struct UnitRegistry {
    /*
        ...
        - prefixedIdentifiers:
            Generated decimal/binary prefix identifiers whose authored token is
            itself the preferred display spelling.
    ...
    QSet<QString> prefixedIdentifiers;
...
struct ReadableUnitScore {
    int bucket = 3;
    HNumber value = HNumber(0);
};

ReadableUnitScore readableUnitScore(const HNumber& baseValue, const CNumber& unit)
{
    const auto abs = [](const HNumber& value) {
        return value < HNumber(0) ? -value : value;
    };

    ReadableUnitScore score;
    if (!unit.isNearReal() || unit.real.isNearZero())
        return score;

    score.value = abs(baseValue / unit.real);
...
bool isBetterReadableUnitScore(const ReadableUnitScore& a, const ReadableUnitScore& b)
{
...
int unitPrefixPolicy(UnitId id)
{
    ...
    if (it == s_unitSpecs().constEnd())
        return NoPrefixes;
    return it.value().prefixPolicy;
}

bool unitPrefixPolicyAllows(int policy, const UnitPrefixSpec& prefix, bool binaryPrefix)
{
    if (binaryPrefix)
        return policy & BinaryIecPrefixes;

    if (prefix.power == 0)
        return false;

    const bool engineering = prefix.power % 3 == 0;
    if (prefix.power < 0)
        return policy & (engineering ? NegativeEngineeringSiPrefixes : SmallNegativeSiPrefixes);
    return policy & (engineering ? PositiveEngineeringSiPrefixes : SmallPositiveSiPrefixes);
}

QString unitSiPrefixBaseSymbol(UnitId id)
{
    const UnitId baseId = id == UnitId::Kilogram ? UnitId::Gram : id;
    const auto it = s_unitSpecs().constFind(baseId);
    if (it == s_unitSpecs().constEnd() || it.value().prefixPolicy == NoPrefixes)
        return QString();
    return it.value().symbol;
}
...
CNumber unitSiPrefixBaseValue(UnitId id)
{
    const UnitId baseId = id == UnitId::Kilogram ? UnitId::Gram : id;
    const auto it = s_unitSpecs().constFind(baseId);
    if (it == s_unitSpecs().constEnd() || !it.value().linearValue)
        return CNumber(0);
    return it.value().linearValue().numericValue();
}

bool shouldAddSiPrefixedShortAlias(const QString& prefixSymbol, const QString& unitShortName)
{
    Q_UNUSED(prefixSymbol)
    Q_UNUSED(unitShortName)
    return true;
}
...
{
    static const QSet<QString> untranslatableNames = {
        QStringLiteral("acre"),
        QStringLiteral("Ampere"),
        QStringLiteral("Becquerel"),
        QStringLiteral("bit"),
        QStringLiteral("candela"),
        QStringLiteral("Coulomb"),
        QStringLiteral("Farad"),
        QStringLiteral("Gray"),
        QStringLiteral("Henry"),
        QStringLiteral("Hertz"),
        QStringLiteral("Joule"),
        QStringLiteral("katal"),
        QStringLiteral("Kelvin"),
        QStringLiteral("lumen"),
        QStringLiteral("lux"),
        QStringLiteral("nat"),
        ...
        QStringLiteral("quad"),
        QStringLiteral("Siemens"),
        QStringLiteral("sievert"),
        QStringLiteral("stone"),
        QStringLiteral("Tesla"),
        QStringLiteral("Torr"),
        QStringLiteral("Volt"),
        QStringLiteral("Watt"),
        QStringLiteral("Weber"),
    };

    return !untranslatableNames.contains(localizedName);
}
...
void Units::findUnit(Quantity& q)
{
    ...
    const auto tryReadablePrefixedDisplayUnit = [&]() {
        if (!q.numericValue().isNearReal())
            return false;
        if (dim.isEmpty())
            return false;
        ...
        const HNumber baseValue = q.numericValue().real;
        const QHash<UnitId, UnitSpec>& specs = s_unitSpecs();
        bool canonicalAlreadyReadable = false;
        Candidate best;

        const auto considerCandidate = [&](const QString& name, const Quantity& value) {
            if (name.isEmpty())
                return;
            Quantity candidate(value);
            candidate.cleanDimension();
            const QMap<UnitQuantity, Rational> candidateDim = candidate.getDimensionByQuantity();
            if (candidateDim != dim || denyAutoCanonicalization(name, candidateDim))
                return;
            const ReadableUnitScore candidateScore = readableUnitScore(
                baseValue,
                candidate.numericValue());
            if (candidateScore.bucket != 0)
                return;
            if (best.name.isEmpty() || isBetterReadableUnitScore(candidateScore, best.score))
                best = Candidate{name, candidate.numericValue(), candidateScore};
        };

        for (const UnitId id : s_unitSpecOrder()) {
            const UnitSpec& spec = specs.value(id);
            if (spec.prefixPolicy == NoPrefixes || !spec.linearValue || spec.affine.toBase)
                continue;

            Quantity baseUnitValue = spec.linearValue();
            baseUnitValue.cleanDimension();
            const QMap<UnitQuantity, Rational> candidateDim = baseUnitValue.getDimensionByQuantity();
            if (candidateDim != dim || denyAutoCanonicalization(spec.name, candidateDim))
                continue;

            if ((spec.family == UnitFamily::SiBase || spec.family == UnitFamily::SiDerived)
                && readableUnitScore(baseValue, baseUnitValue.numericValue()).bucket == 0)
            {
                canonicalAlreadyReadable = true;
            }

            if (spec.family != UnitFamily::SiBase && spec.family != UnitFamily::SiDerived)
                considerCandidate(spec.symbol.isEmpty() ? spec.name : spec.symbol, baseUnitValue);

            // Area and volume have explicit prefixed units, but generating
            // prefixes from m²/m³ changes powers by the exponent and produces
            // surprising display choices for ordinary square/cubic units.
            if (id == UnitId::SquareMetre || id == UnitId::CubicMetre || id == UnitId::Kilogram)
                continue;
            ...
            for (const PrefixSpec& prefix : s_siPrefixes()) {
                ...
                if (id == UnitId::Second && prefix.power > 0)
                    continue;
                if (!unitPrefixPolicyAllows(spec.prefixPolicy, prefix))
                    continue;
                if (spec.symbol.isEmpty()
                    || !shouldAddSiPrefixedShortAlias(prefix.symbol, spec.symbol))
                {
                    continue;
                }
                considerCandidate(prefix.symbol + spec.symbol, prefix.value * baseUnitValue);
            }
        }

        if (canonicalAlreadyReadable || best.name.isEmpty())
            return false;

        q.setDisplayUnit(best.value, best.name);
        return true;
    };
    ...
    if (tryReadablePrefixedDisplayUnit())
        return;
    if (dim.size() == 1
        && dim.value(UnitQuantity::Mass) == Rational(1)
        && q.hasUnit()
        && q.numericValue().isNearReal()
        && q.unit().isNearReal())
    {
        HNumber kilogramValue = q.numericValue().real;
        if (kilogramValue < HNumber(0))
            kilogramValue = -kilogramValue;
        if (kilogramValue >= HNumber(1) && kilogramValue < HNumber(1000)) {
            q.setDisplayUnit(CNumber(1), unitName(UnitId::Kilogram));
            return;
        }
    }
...
static UnitRegistry s_buildUnitRegistry()
{
    ...
    const auto addUnique = [&](const QString& name,
        ...
        if (prefixedIdentifier)
            registry.prefixedIdentifiers.insert(name);
    };
    ...
    for (const PrefixSpec& prefix : s_siPrefixes()) {
        for (const UnitAliasSpec& unit : unitAliasSpecs) {
            if (!unitPrefixPolicyAllows(unit.prefixPolicy, prefix))
                continue;
            if (unit.id == UnitId::SquareMetre || unit.id == UnitId::CubicMetre)
                continue;
            ...
            const bool keepPrefixedDisplay = prefix.power > 0 && prefix.power < 3;
            // Long form: kilo + metre => kilometre
            addUnique(prefix.longName + unit.longName, prefixedValue, localized, unit.id, keepPrefixedDisplay);
            if (!unit.shortName.isEmpty()
                && shouldAddSiPrefixedShortAlias(prefix.symbol, unit.shortName))
                // Symbol form: k + m => km; k + m² => km²; k + m³ => km³
                addUnique(prefix.symbol + unit.shortName, prefixedValue, localized, unit.id, keepPrefixedDisplay);
            if (!unit.alternateShortName.isEmpty()
                && shouldAddSiPrefixedShortAlias(prefix.symbol, unit.alternateShortName))
                addUnique(prefix.symbol + unit.alternateShortName, prefixedValue, localized, unit.id, keepPrefixedDisplay);
        }
    }
    ...
    for (const PrefixSpec& prefix : s_binaryPrefixes()) {
        for (const UnitAliasSpec& unit : unitAliasSpecs) {
            if (!unitPrefixPolicyAllows(unit.prefixPolicy, prefix, true))
                continue;
            const Quantity prefixedValue = prefix.value * unit.value;
            const QString localized = prefixedLocalizedName(prefix.longName, unit.localized);
...
QHash<QString, Quantity> Units::builtInUnitLookup(char angleMode)
{
    ...
    for (auto it = unitValues.constBegin(); it != unitValues.constEnd(); ++it) {
        ...
        const bool keepDisplayUnit =
            (id == UnitId::Steradian)
            || s_unitRegistry().prefixedIdentifiers.contains(identifier)
            || ((id == UnitId::Hertz
              || id == UnitId::Becquerel
              || id == UnitId::Gray
              || id == UnitId::Sievert
